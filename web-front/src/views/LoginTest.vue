        ...
        <div class="sign_box">
            ...
            <div class="signIn" v-if="status==1">
                <el-form :model="loginForm" :rules="loginRules" ref="loginForm" label-width="0px" key="login">
                    <el-form-item class="card" prop="username">
                        <!-- <span class="front">账号：</span> -->
                        <el-input class="back" v-model="loginForm.username" placeholder="请输入账号"></el-input>
                    </el-form-item>
                    <el-form-item class="card" prop="password">
                        <!-- <span class="front">密码：</span> -->
                        <el-input class="back" type="password" v-model="loginForm.password" placeholder="请输入密码"></el-input>
                    </el-form-item>
                    <el-form-item>
